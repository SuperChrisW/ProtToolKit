...
# eg.
# 'model_path': './pred/complex/8r7t_relaxed_rank_001_alphafold2_multimer_v3_model_2_seed_000.pdb'
# 'native_path': './truth/complex/8r7t.pdb'
# 'model_chains': 'AB' (the chain order should match between model and native, and the last chain 'B' should be cyclic peptide chain)
# 'native_chains': 'BC'
